...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sitecore_netcore_auth.localhost"
}
catch {
...
Add-HostsEntry "cm.sitecore_netcore_auth.localhost"
Add-HostsEntry "cd.sitecore_netcore_auth.localhost"
Add-HostsEntry "id.sitecore_netcore_auth.localhost"
Add-HostsEntry "www.sitecore_netcore_auth.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.sitecore_netcore_auth.localhost"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.sitecore_netcore_auth.localhost"

    # RENDERING_HOST
    Set-DockerComposeEnvFileVariable "RENDERING_HOST" -Value "www.sitecore_netcore_auth.localhost"
